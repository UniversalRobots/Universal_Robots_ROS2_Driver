...
#ifndef UR_CLIENT_LIBRARY_CONTROL_PACKAGE_START_H_INCLUDED
#define UR_CLIENT_LIBRARY_CONTROL_PACKAGE_START_H_INCLUDED
...
#endif  // UR_CLIENT_LIBRARY_CONTROL_PACKAGE_START_H_INCLUDED
