...
def generate_launch_description():
    ...
    # RViz
    rviz_config_file = (
        get_package_share_directory("ur_ros2_control_demos") + "/config/rviz/demo_rviz_config.rviz"
    )
    rviz_node = Node(
        package="rviz2",
        executable="rviz2",
    ...
    return LaunchDescription(
        [ros2_control_node, rviz_node, robot_state_pub_node, container, static_tf]
    )
