...
def generate_launch_description():
    ...
    declared_arguments.append(DeclareLaunchArgument(
        ...
        description='Name of the description package for used UR robot and scenario.'))
    declared_arguments.append(DeclareLaunchArgument(
        'robot_ip',
        description='IP address by which the robot can be reached.'))

    ur_type = LaunchConfiguration('ur_type')
    substitutions.append(LogInfo(msg=ur_type))

    robot_ip = LaunchConfiguration('robot_ip')

    description_package = LaunchConfiguration('description_package')
    substitutions.append(LogInfo(msg=description_package))

    substitutions.append(LogInfo(msg="Testko23244"))

    #print(TextSubstitution('ur_type'))
    #print(TextSubstitution(LaunchConfiguration('ur_type')))
    #print(LaunchConfiguration('ur_type'))
    #print(PathJoinSubstitution(LaunchConfiguration('ur_type')))
    #print(get_package_share_directory(description_package))
    joint_limit_params = PathJoinSubstitution([
        get_package_share_directory('ur_description'), 'config', ur_type, 'joint_limits.yaml'])
    #substitutions.append(LogInfo(msg=joint_limit_params_sub))
    ...
    substitutions.append(LogInfo(msg=robot_description))
    ...
    return LaunchDescription(declared_arguments + substitutions + [])
