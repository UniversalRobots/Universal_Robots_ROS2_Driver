...
def generate_launch_description():
    ...
    position_goals = PathJoinSubstitution(
        [FindPackageShare("ur_simulation_gazebo"), "config", "test_goal_publishers_config.yaml"]
    )
    ...
    return LaunchDescription(
        [
            Node(
                ...
                remappings={('/joint_trajectory_controller/joint_trajectory', '/joint_trajectory_controller/joint_trajectory')},
                output={
                    "stdout": "screen",
                    "stderr": "screen",
                },
