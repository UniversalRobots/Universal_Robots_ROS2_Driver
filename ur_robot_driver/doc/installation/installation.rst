...
1. `Install ROS2 <https://docs.ros.org/en/lyrical/Get-Started/Installation/Ubuntu-Install-Debs.html>`_. This
   branch supports only ROS2 Lyrical. For other ROS2 versions, please see the respective branches.
...
1. `Install ROS2 <https://docs.ros.org/en/lyrical/Get-Started/Installation/Ubuntu-Install-Debs.html>`_. This
   ...
   Once installed, please make sure to actually `source ROS2 <https://docs.ros.org/en/lyrical/Get-Started/Configuring-ROS2-Environment.html#source-the-setup-files>`_ before proceeding.
