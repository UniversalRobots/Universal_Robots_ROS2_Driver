...
msg_moveJ_2.additional_arguments = [MotionArgument(argument_name="move_time", argument_value=2.0)]
...
class MotionPublisher(Node):
    def __init__(self):
        ...
        # self.messages = [msg_moveJ_1, msg_moveJ_2, msg_moveL_1, msg_moveL_2, msg_moveC_1]
