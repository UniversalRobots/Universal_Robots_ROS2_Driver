...
class TrajectoryPublisher(Node):
    ...
    def publish_trajectory_sequence(self):
        ...
        points = [
            ...
            JointTrajectoryPoint(
                positions=[1.57, -1.1, 1.0, -1.57, -1.57, -1.57],
                velocities=[0.0] * 6,
                time_from_start=rclpy.duration.Duration(seconds=1).to_msg(),
            ),
            JointTrajectoryPoint(
                positions=[2.0, -0.9, 0.7, -1.57, -1.57, -1.57],
                velocities=[0.0] * 6,
                time_from_start=rclpy.duration.Duration(seconds=2).to_msg(),
            ),
            JointTrajectoryPoint(
                positions=[2.4, -1.57, 1.57, -1.57, -1.57, -1.57],
                velocities=[0.0] * 6,
                time_from_start=rclpy.duration.Duration(seconds=3).to_msg(),
            ),
            JointTrajectoryPoint(
                positions=[1.57, -1.57, 1.57, -1.57, -1.57, -1.57],
                velocities=[0.0] * 6,
                time_from_start=rclpy.duration.Duration(seconds=4).to_msg(),
            ),
            JointTrajectoryPoint(
                positions=[1.57, -1.1, 1.0, -1.57, -1.57, -1.57],
                velocities=[0.0] * 6,
            ...
            JointTrajectoryPoint(
                positions=[1.1, -0.9, 0.7, -1.57, -1.57, -1.57],
                velocities=[0.0] * 6,
                time_from_start=rclpy.duration.Duration(seconds=6).to_msg(),
            ),
            JointTrajectoryPoint(
                positions=[0.7, -1.57, 1.57, -1.57, -1.57, -1.57],
                velocities=[0.0] * 6,
                time_from_start=rclpy.duration.Duration(seconds=7).to_msg(),
            ),
            JointTrajectoryPoint(
                positions=[1.57, -1.57, 1.57, -1.57, -1.57, -1.57],
                velocities=[0.0] * 6,
                time_from_start=rclpy.duration.Duration(seconds=8).to_msg(),
            ),
        ]
