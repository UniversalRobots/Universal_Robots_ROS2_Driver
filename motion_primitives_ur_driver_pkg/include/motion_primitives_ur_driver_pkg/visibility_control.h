...
#ifndef MOTION_PRIMITIVES_UR_DRIVER_PKG__VISIBILITY_CONTROL_H_
#define MOTION_PRIMITIVES_UR_DRIVER_PKG__VISIBILITY_CONTROL_H_
...
#endif  // MOTION_PRIMITIVES_UR_DRIVER_PKG__VISIBILITY_CONTROL_H_
